...
public class Usuario {
    ...
    @Column(name = "last_reactivation_email_sent")
    private LocalDateTime lastReactivationEmailSent;
    ...
    public LocalDateTime getLastReactivationEmailSent() {
        return lastReactivationEmailSent;
    }

    public void setLastReactivationEmailSent(LocalDateTime lastReactivationEmailSent) {
        this.lastReactivationEmailSent = lastReactivationEmailSent;
    }
